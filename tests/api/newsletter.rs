...
// helpers
// use pub api of the app to create an unconfirmed sub
...
async fn create_confirmed_subscriber(app: &TestApp) {
    // reuse helper and add a step to call confirm link
...
// short-hand for a common mock setup
...
// tests
#[tokio::test]
async fn you_must_be_logged_in_to_see_the_publish_newlsetter_form() {
    // arrange
...
async fn concurrent_form_submission_is_handled_gracefully() {
    ...
    // act: submit two forms concurrently
    let newsletter_request_body = serde_json::json!({
        "title": "Newsletter title",
        "text_content": "Newsletter body as plain text",
        "html_content": "<p>Newsletter body as HTML</p>",
